...
ANNO_PATH="${ANNO_PATH:-/your/data/svfeye_data}"
BENCHMARK="hr-bench_8k"
CONF_THRESHOLD="${CONF_THRESHOLD:-1.00}"

MODE_FLAG=""
MERGE_FILE_SUFFIX="_svfeye"
if [[ "$1" == "direct" ]]; then
...
echo "Score with:"
echo "python svfeye/eval/eval_results_hr-bench.py --answers-file ${MERGE_FILE}"
echo "========================================="
